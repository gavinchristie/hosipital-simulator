 ...
 */
/**
 * Last modified: October 20th 2017 by Gavin Christie
 * Modification to the insertSorted function to use as implementation as a priority queue
 * Also modified the structure to include two compare functions, one for list priority and one for data
 */
...
/** Function to return pointer to data being searched for
 * @param list The list being searched through
 * @param data The data being searched for
 * @return Returns void pointer to the data and NULL if the data is not found in the list
 */
